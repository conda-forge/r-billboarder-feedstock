...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-billboarder-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-billboarder-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-billboarder
# for installing globally
pixi global install r-billboarder
```
...
It is possible to list all of the versions of `r-billboarder` available on your platform:
...
```
pixi search r-billboarder --channel conda-forge
```
